          ...
          <div className={styles.heroContent}>
            ...
            >
              <h1 className={styles.heroTitle}>
                Advanced Hair Restoration Powered by <span className={styles.accent}>AI, Science & Precision</span>
              </h1>

              <p className={styles.heroDescription}>
                At MediNex+, we specialize in advanced hair restoration and scalp treatments using AI-based diagnostics, regenerative therapies, and modern transplant techniques.
              </p>
